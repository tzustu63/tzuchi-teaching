...
- 🐳 Docker 部署：支援 AWS Lightsail 等雲端平台
- 🔐 安全儲存：API Key 加密儲存
...
2. **克隆專案**
   ```bash
   git clone https://github.com/tzustu63/tzuchi-teaching.git
   cd tzuchi-teaching
   git checkout V1
   ```
...
5. **驗證部署**
   ...
   - 測試主要流程（生成課程計劃、Gamma PPT 等）

### 更新部署

```bash
cd /home/ubuntu/tzuchi-teaching
git pull origin V1
docker-compose -f docker-compose.prod.yml up -d --build
```
...
- ✅ 階段 6: Gamma API 整合 - 完成
- ✅ 階段 7: AWS Lightsail Docker 部署 - 完成
